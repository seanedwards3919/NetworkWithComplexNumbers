...
acnfl_NumberObject* neuronLayer_changeInWeights(neuronLayer_RegularLayer, neuronLayer_RegularLayer); /** IMPLEMENT NEXT */
acnfl_NumberObject* neuronLayer_changeInBiases(neuronLayer_RegularLayer); /** IMPLEMENT NEXT */
